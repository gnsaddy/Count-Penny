        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h3 class="login-heading mb-4 text-center"><u>Display details of flexibleExpense for unsalaried user</h3></u>
                        <table class="table table-bordered table-responsive">
                            <?php
                                $queryShow = "select u.fname,u.userId,ut.uType,u.netIncome+u.otherIncome as Income,e.expenseId,sum(fl.flAmount) as Flexible
                                                ...
                                                where u.userId=ut.userId and u.userId=h.userId and e.expenseId=h.expenseId and ut.uType=\"unsalaried\" and
